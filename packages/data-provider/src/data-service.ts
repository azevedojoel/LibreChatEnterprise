...
/* Workflows */
export const listWorkflows = (): Promise<q.TWorkflow[]> =>
  request.get(endpoints.workflows());

export const getWorkflow = (id: string): Promise<q.TWorkflow> =>
  request.get(endpoints.workflow(id));

export const createWorkflow = (data: {
  name: string;
  nodes?: q.TWorkflowNode[];
  edges?: q.TWorkflowEdge[];
}): Promise<q.TWorkflow> => request.post(endpoints.workflows(), data);
...
): Promise<q.TWorkflow> => request.patch(endpoints.workflow(id), data);

export const deleteWorkflow = (id: string): Promise<void> =>
  request.delete(endpoints.workflow(id));

export const runWorkflow = (workflowId: string): Promise<q.RunWorkflowResponse> =>
  request.post(endpoints.workflowRun(workflowId));
...
export const getWorkflowSchedules = (
  ...
  request.get(endpoints.workflowSchedules(workflowId));
...
export const createWorkflowSchedule = (
  ...
  request.post(endpoints.workflowSchedules(workflowId), data);
...
export const updateWorkflowSchedule = (
  ...
  request.patch(endpoints.workflowSchedule(workflowId, scheduleId), data);

export const deleteWorkflowSchedule = (
  workflowId: string,
  scheduleId: string,
): Promise<void> =>
  request.delete(endpoints.workflowSchedule(workflowId, scheduleId));

export const runWorkflowSchedule = (
  workflowId: string,
  scheduleId: string,
): Promise<{
  success: boolean;
  ...
  request.post(endpoints.workflowSchedule(workflowId, scheduleId) + '/run');
