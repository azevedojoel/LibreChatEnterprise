...
- **Option 3: Discord Server**: You can join our [Discord community](https://dailythread.ai) and initiate first contact in the `#issues` channel. However, please ensure that initial contact through Discord does not include any sensitive details.
...
- Repository: [Daily Thread](https://dailythread.ai)

## Contact

If you have any questions or concerns regarding the security of our project, please join our [Discord community](https://dailythread.ai) and report them in the appropriate channel. You can also reach out to us by opening an issue on GitHub. Please note that the response time may vary depending on the nature and severity of the inquiry.
