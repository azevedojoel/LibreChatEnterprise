...
- For create_schedule: use name (user-friendly), agentId (from the injected list), prompt (what to send), scheduleType (recurring or one-off). For recurring use cronExpression; for one-off use runAt (ISO date).`;
