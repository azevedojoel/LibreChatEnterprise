...
const permissions: PermissionConfig[] = [
  { permission: Permissions.USE, labelKey: 'com_ui_workflows_allow_use' },
  { permission: Permissions.CREATE, labelKey: 'com_ui_workflows_allow_create' },
];

const WorkflowsAdminSettings = () => {
  ...
  return (
    <AdminSettingsDialog
        ...
        sectionKey="com_ui_workflows"
        permissions={permissions}
        menuId="workflow-role-dropdown"
        mutation={mutation}
        trigger={trigger}
...
export default WorkflowsAdminSettings;
